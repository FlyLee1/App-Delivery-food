              ...
              {tab === "desc" ? (
                ...
                <div className="tab__form mb-3">
                  ...
                  <div className="review">
                    <p className="user__name mb-0">Sharon</p>
                    <p className="user__email">sharon@gmail.com</p>
                    <p className="feedback__text">Great product</p>
                  </div>
                  <div className="review">
                    <p className="user__name mb-0">JWick</p>
                    <p className="user__email">jwick@gmail.com</p>
                    <p className="feedback__text">Great product</p>
                  </div>
